...
![Default navigation bar of Bonito.](https://via.placeholder.com/1000x100)
...
![Signed in nav bar.](https://via.placeholder.com/1000x100)
...
![Expanded nav bar.](https://via.placeholder.com/1000x100)
...
![Populated search with top 6 suggestions](https://via.placeholder.com/1000x750)
...
![Populated search with all suggestions when there are less than 6 suggestions](https://via.placeholder.com/1000x750)

If there are less than 6 search results, all search results will appear.

![Full results of search page](https://via.placeholder.com/1000x750)
...
![No suggestions result](https://via.placeholder.com/1000x750)
...
![Page to suggest new ingredients, unpopulated](https://via.placeholder.com/1000x750)
...
![Page to suggest new ingredients, populated with food name](https://via.placeholder.com/1000x750)
...
![Page to suggest new ingredients, populated with only comments](https://via.placeholder.com/1000x750)
...
![Page to suggest new ingredients, successful submission window](https://via.placeholder.com/1000x750)
...
![Page of a specific ingredient](https://via.placeholder.com/1000x750)
...
![Page of a specific ingredient, login prompt when voting](https://via.placeholder.com/1000x750)
...
![Page of a specific ingredient, logged in and successful vote](https://via.placeholder.com/1000x750)
...
![Page of a specific ingredient, no locations provided](https://via.placeholder.com/1000x750)
...
![Page of a specific ingredient, suggesting a new location, unpopulated](https://via.placeholder.com/1000x750)
...
![Page of a specific ingredient, suggesting a new location, populated with suggestions](https://via.placeholder.com/1000x750)
...
![Page of a specific ingredient, suggesting a new location, fully populated address](https://via.placeholder.com/1000x750)

### TODO
Clicking one of them will fill the input field with the remaining address information. We will be using the Google Maps API to manage location data. Write here about how Google will be integrated to search for addresses. This way, only valid addresses can be submitted.

Users click the “Submit” button to report a new location for that ingredient.

![Page of a specific ingredient, suggesting a new location, populated but no suggestions](https://via.placeholder.com/1000x750)

If there are no results, the message “No results found. Please try again” will appear. 

![Page of a specific ingredient, new location suggested](https://via.placeholder.com/1000x750)
...
![Google auth page, error/re-attempt](https://via.placeholder.com/1000x750)
...
![About us page for Bonito](https://via.placeholder.com/1000x750)
